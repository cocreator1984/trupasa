...
export default async function Home({ params }: { params: { locale: "en"|"sv"|"so" } }) {
  const common = (await import(`../../locales/${params.locale}/common.json`)).default; const t = createTranslator({locale: params.locale, messages: { default: common }, namespace: "default"});
  return (
    <main>
